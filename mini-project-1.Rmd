...
Here I will explore the vancouver_trees datase 
...
Here I will explore the apt_buildings dataset 
...
Here I will explore the flow_sample dataset 
...
Here I will explore the parking_meters dataset 
...
<!-------------------------- Start your work below ---------------------------->
I chose the vancouver_trees dataset. I was most interested in this dataset because this past summer I worked in urban forestry research, and a large part of my job was learning how to identify all of the tree species where I worked in Ontario as well as taking various measurements of trees. Since I just moved to British Columbia, I've been curious about the different tree species here but I haven't had much time to look into it since I've been in school. This is why I am genuinely very interested in this dataset! 
<!----------------------------------------------------------------------------->
...
<!-------------------------- Start your work below ---------------------------->
I would like to explore the relationship between diameter and date_planted. With this I would like to find out if the oldest trees are the largest by diameter. 
<!----------------------------------------------------------------------------->
...
Here I will be exploring the *vancouver_trees* dataset from the *datateachr* package, using the *dplyr* and *ggplot2* packages for anaysis. 

### Plotting the distribution of a numeric variable 
 
Here I will be plotting the distribution of the *diameter* variable. I chose this exercise to visualize general trends of size of trees by diameter. This is to start broad, not looking at specific types of trees yet. 
...
Here I will be plotting the relationship between the diameter and the date the trees were planted. This is to get more specific from the last analysis, and to find out if the oldest trees tend to be the largest by diameter in Vancouver. I am using a scatterplot because both *diameter* and *date_planted* are continuous variables. Interestingly, it looks like the largest tree by diameter was planted in the mid 2000s, and not in the 1990s like I had expected. 
...
Here I will be filtering the vancouver_trees tibble and making a tibble of all of the trees in downtown Vancouver. I will be doing this by filtering the *neighbourhood_name* to be *DOWNTOWN*, and selecting the *tree_id*, *genus_name*, *species_name*, *cultivar_name*, and *common_name* variables. I have noticed that downtown has a lot of greenery compared to the downtown of other cities, like Toronto, so I am curious about the trees that are planted here and will be using this tibble to explore that. 
...
Here I will use a boxplot to look at the frequency of *diameter* observations within the *curb* variable. This is to observe whether trees tend to be larger or smaller when they are or are not next to a curb. 
...
##Research Questions 
  ...
  3. How does *side_street_name* relate to *curb*? For example, does the odd numbered side of the street have more trees next to a curb than the even numbered side? 
